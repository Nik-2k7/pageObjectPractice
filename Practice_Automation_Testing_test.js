...
Scenario("17.Home-Arrivals-Add to Basket-Items-Check-out-Payment Gateway", async ({ I, practice_pageobjectPage }) => {
    ...
    await I.click(practice_pageobjectPage.label_proceedToCheckout);
    await I.wait(2);
    await I.fillField(practice_pageobjectPage.input_firstName, 'Nitish');
    await I.wait(2);
    await I.fillField(practice_pageobjectPage.input_lastName, 'Kumar');
    await I.wait(2);
    await I.fillField(practice_pageobjectPage.input_companyName, 'Crowdstaffing');
    await I.wait(2);
    await I.fillField(practice_pageobjectPage.input_emailAddress, 'nitishk@crowdstaffing.com');
    await I.wait(2);
    await I.fillField(practice_pageobjectPage.input_phoneNo, '+91 7980268083');
    await I.wait(3);
    await I.see('India');
    await I.wait(3);
    await I.fillField(practice_pageobjectPage.input_Address, '26, Harishankar Lane');
    await I.wait(2);
    await I.fillField(practice_pageobjectPage.input_townCity, 'Kolkata');
    await I.wait(2);
    await I.see('Telangana');
    await I.wait(3);
    await I.fillField(practice_pageobjectPage.input_postCode, '7000034');
    await I.wait(2);
    await I.click('//input[@value="cod"]');
    await I.wait(2);
    await I.click('//a[contains(text(),"Click here to enter your code")]');
    await I.wait(2);
    await I.fillField(practice_pageobjectPage.input_coupon, 'krishnasakinala');
    await I.click('//input[@value="Apply Coupon"]');
    await I.wait(2);
    await I.see('Coupon code applied successfully.');
    await I.wait(2);
});

Scenario("18.Home-Arrivals-Add to Basket-Items-Check-out-Payment Gateway-Place Order", async ({ I, practice_pageobjectPage }) => {
    practice_pageobjectPage.HomePageArrival();
    practice_pageobjectPage.ThreeArrivals();
    await I.click(practice_pageobjectPage.label_ImageSelenium);
    await I.waitForNavigation({});
    ...
    await I.fillField(practice_pageobjectPage.input_emailAddress, 'nitishk@crowdstaffing.com');
    await I.wait(2);
    await I.filFiel d(practice_pageobjectPage.input_phoneNo, '+91 7980268083');
    await I.wait(3);
    await I.see('India');
    await I.wait(3);
    await I.fillField(practice_pageobjectPage.input_Address, '26, Harishankar Lane');
    ...
    await I.see('Coupon code applied successfully.');
    await I.wait(2);
    await I.click('//input[@id="place_order"]');
    await I.wait(5);
    await I.see('Thank you. Your order has been received.');
    await I.see(3);
});